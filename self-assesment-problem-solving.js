...
let getInch = feetToInch(2.4);
// console.log(getInch, " Inc");
...
let getMeter = centimeterToMeter(50);
...
function paperRequirements(
    firstBookNumberOfCopy,
    secondBookNumberOfCopy,
    thirdBookNumberOfCopy
) {
    const firstBookPages = 100 * firstBookNumberOfCopy;
    const secondBookPages = 200 * secondBookNumberOfCopy;
    const thirdBookPages = 300 * thirdBookNumberOfCopy;

    let totalNumberOfPages = firstBookPages + secondBookPages + thirdBookPages;
    return totalNumberOfPages;
}
const getTotalPages = paperRequirements(2, 5, 3);
...
let positiveNumber = getPositiveNumbers(numbers);
